...
const KanbanBoard = () => {
    ...
    useEffect(() => {
        setHeader("Kanban Board", "Holistic operational overview and strategic metrics");
        fetchProjects();
    }, [setHeader]);
    ...
    return (
        <div className="p-3 sm:p-8 bg-background min-h-screen no-scrollbar">
            <div className="max-w-7xl mx-auto space-y-6 sm:space-y-10">
                <div className="flex flex-col md:flex-row md:items-end justify-end gap-4 sm:gap-6">
                    ...
                    {projects.length > 0 && (
                        <div className="flex flex-col gap-2">
                            ...
                            <select
                                ...
                                className="flex h-12 rounded-2xl border border-border bg-secondary px-4 py-2 text-sm font-bold text-foreground Montserrat focus:outline-none focus:ring-2 focus:ring-primary/20 w-full sm:min-w-[320px] transition-all cursor-pointer hover:bg-accent"
                            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                    <Card className="lg:col-span-3 bg-card/50 border-border ring-1 ring-border rounded-3xl overflow-hidden glass">
                        <CardContent className="p-8">
                            <div className="flex items-center justify-between mb-8">
                                <h3 className="text-[11px] font-black text-muted-foreground uppercase tracking-[0.3em] Montserrat">Mission Phases</h3>
                                ...
                                {projectData.stages.map((stage, index) => (
                                    <div key={index} className="flex flex-col items-center group">
                                        ...
                                        <div className="text-center">
                                            <div className="text-[11px] font-black text-foreground Montserrat uppercase tracking-widest mb-1 group-hover:text-primary transition-colors">
                                                {stage.name}
                                            </div>
                            ...
                            <div className="mt-10 pt-8 border-t border-border">
                                <div className="flex justify-between items-end mb-2">
                                    ...
                                    <span className="text-lg font-black text-foreground Montserrat">
                    ...
                    <Card className="border-0 bg-gradient-to-br from-[#10B981] to-[#047857] shadow-[0_20px_50px_-10px_rgba(16,185,129,0.3)] rounded-3xl overflow-hidden relative group">
                        <CardContent className="p-8 flex flex-col items-center justify-center text-center h-full relative z-10">
                            ...
                            <div className="text-[11px] font-black text-muted-foreground uppercase tracking-[0.2em] Montserrat mb-1">
                                Strategic Launch
                            </div>
                            <div className="text-5xl font-black text-foreground Montserrat mb-2 tracking-tighter">
                            ...
                            <div className="w-full py-3 bg-muted rounded-2xl border border-border backdrop-blur-sm">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <Card className="bg-card/50 border-border ring-1 ring-border rounded-3xl glass">
                        <CardHeader className="p-8 pb-0">
                            <CardTitle className="text-[11px] font-black text-muted-foreground uppercase tracking-[0.3em] Montserrat">Financial Vector</CardTitle>
                        </CardHeader>
                        <CardContent className="p-8">
                        ...
                        <CardContent className="p-8 pt-0">
                            {overdueTasks.length > 0 ? (
                                <div className="space-y-3 mt-4">
                                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4 text-[9px] font-black text-gray-700 uppercase tracking-widest Montserrat pb-3 border-b border-white/5">
                                        <div>Staleness</div>
                                        <div>Task Directive</div>
                                        <div className="hidden sm:block">Target Date</div>
                                        <div className="hidden sm:block">Lead</div>
                                    </div>
                                    {overdueTasks.map((task, index) => (
                                        <div key={index} className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4 text-xs items-center py-3 border-b border-white/5 last:border-0 group cursor-default">
                                            <div>
                                            ...
                                            <div className="text-foreground font-bold Montserrat group-hover:text-red-400 transition-colors truncate">{task.task}</div>
                                            <div className="text-gray-600 Montserrat font-bold text-[10px] hidden sm:block">{task.deadline}</div>
                                            <div className="text-foreground font-black Montserrat text-[10px] hidden sm:block">{task.employee}</div>
                                        </div>
                                    ))}
                                </div>
                            ) : (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 pb-12">
                    ...
                    <Card className="bg-card/50 border-border ring-1 ring-border rounded-3xl glass">
                        <CardHeader className="p-8 pb-0">
                            <CardTitle className="text-[11px] font-black text-muted-foreground uppercase tracking-[0.3em] Montserrat">Team Workload Velocity</CardTitle>
                        </CardHeader>
                        <CardContent className="p-8">
                    ...
                    <Card className="bg-card/50 border-border ring-1 ring-border rounded-3xl glass">
                        <CardHeader className="p-8 pb-4">
                            <CardTitle className="text-[11px] font-black text-muted-foreground uppercase tracking-[0.3em] Montserrat">Next 14 Days Forecast</CardTitle>
                        </CardHeader>
                        <CardContent className="p-8 pt-0">
                            {upcomingDeadlines.length > 0 ? (
                                <div className="space-y-4 mt-4">
                                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4 text-[9px] font-black text-gray-700 uppercase tracking-widest Montserrat pb-3 border-b border-white/5">
                                        ...
                                        <div className="hidden sm:block">Complexity</div>
                                    </div>
                                    {upcomingDeadlines.map((item, index) => (
                                        <div key={index} className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4 text-xs items-center py-3 border-b border-white/5 last:border-0 group cursor-default">
                                            <div className="text-foreground font-black Montserrat text-[10px]">{item.employee}</div>
                                            <div className="text-foreground font-bold Montserrat group-hover:text-primary transition-colors truncate">{item.task}</div>
                                            <div className="text-gray-500 Montserrat font-bold text-[10px] hidden sm:block">{item.deadline}</div>

export const PERMISSION_MODULES = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: 'kanban.manageColumns', label: 'Manage Columns', description: 'Create/edit/delete columns', defaults: { MANAGER: true, MEMBER: false, CLIENT: false } }
    ]
  },
  {
    key: 'team',
    ...
    permissions: [
      { key: 'team.view', label: 'View Team', description: 'View team member list', defaults: { MANAGER: true, MEMBER: false, CLIENT: false } },
      { key: 'team.invite', label: 'Invite Members', description: 'Invite new members', defaults: { MANAGER: true, MEMBER: false, CLIENT: false } },
      { key: 'team.editRoles', label: 'Edit Roles', description: 'Change user roles', defaults: { MANAGER: false, MEMBER: false, CLIENT: false } },

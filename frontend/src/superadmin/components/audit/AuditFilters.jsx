    ...
    <div className="flex flex-col sm:flex-row items-center gap-4 w-full">
      <div className="flex flex-col sm:flex-row items-center gap-4 w-full">
        <Popover>
          ...
          <PopoverContent
            align="start"
            className="w-[260px] p-2 rounded-2xl border-border/40 bg-background dark:bg-black shadow-[0_0_50px_rgba(0,0,0,0.15)] dark:shadow-[0_0_50px_rgba(0,0,0,0.8)] backdrop-blur-3xl"
          >
